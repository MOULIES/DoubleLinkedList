...
class DoubleLinkedList:
    ...
    def insert_in_beginning(self, data):
        ...
        temp = Node(data)
        temp.next_node = self.start
        self.start.prev_node = temp
        self.start = temp
    ...
    def insert_after(self, data, x):
        ...
        if p is None:
            ...
            if p.next_node is not None:
                p.next_node.prev_node = temp #should not be done with last node
            p.next_node = temp
    ...
    def insert_before(self, data, x):
        ...
        #################find reference to the node containing x
        p = self.start
